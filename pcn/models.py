...
def load_model():
    ...
    pcn1.load_state_dict(torch.load(pjoin(cwd, 'pth/pcn1_sd.pth'), map_location=torch.device('cpu')))
    pcn2.load_state_dict(torch.load(pjoin(cwd, 'pth/pcn2_sd.pth'), map_location=torch.device('cpu')))
    pcn3.load_state_dict(torch.load(pjoin(cwd, 'pth/pcn3_sd.pth'), map_location=torch.device('cpu')))
